package example.cerki.osuhub.Data.Factories;
...
public class FeedItemFactory {
    ...
    public static FeedItem getFeeditem(String username, BestScore score, example.cerki.osuhub.Data.POJO.Beatmap beatmap){
